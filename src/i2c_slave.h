...
static volatile uint32_t *const I2C0_INTR_MASK = (volatile uint32_t *const)(I2C0_BASE + 0x30);
static volatile uint32_t *const I2C0_CLR_RD_REQ = (volatile uint32_t *const)(I2C0_BASE + 0x50);
